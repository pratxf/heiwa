...
export const metadata: Metadata = {
  title: "Sleep Sounds App for Personal Bedtime Soundscapes",
  description: "Mix calming sleep sounds including rain, fire, ocean, forest, wind, white noise, and brown noise. Save personal mixes and use a sleep timer with Heiwa.",
